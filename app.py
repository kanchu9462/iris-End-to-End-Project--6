...
st.set_page_config(page_title='Iris Project -Kanchan')

#Add a title in browsers body
st.title("Iris End to End Project -Kanchan kurhe")

#Take sepal length ,sepal width,petal length width as input
...
#Write a function to predictspecies along with probability
